...
3. Crea las tablas necesarias. El sistema utiliza las siguientes tablas:
   ...
   | `dispositivo` | Dispositivos vinculados a clientes (marca, version, tipo de reparacion, contrasena) |
   | `reparacion` | Registro de reparaciones (fecha, estado, costos, comentarios) |
   | `factura` | Facturas generadas (fecha, total, referencia a reparacion) |
   | `garantia` | Garantias (estado, observaciones, fechas, insumos, comentarios finales) |
