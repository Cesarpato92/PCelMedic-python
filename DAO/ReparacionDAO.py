...
class ReparacionDAO:
    ...
    def obtener_reparacion_por_id(self, modelo_reparacion):
        ...
        try:
            ...
            valores = (modelo_reparacion.id_reparacion,)
            ...
            if resultado:
                fecha_ingreso, estado, costo_repuesto, precio_reparacion, comentarios, id_dispositivo = resultado
                ...
                reparacion_encontrada.id_dispositivo = id_dispositivo
